      ...
      <footer className="border-t border-white/[0.05] py-12 bg-[#050609]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row gap-6 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link to="/terms" onClick={() => trackEvent("footer_link_click", { destination: "terms" })} className="text-xs font-semibold text-[#8e939e] hover:text-white transition-colors">
              Terms
            </Link>
            <Link to="/privacy" onClick={() => trackEvent("footer_link_click", { destination: "privacy" })} className="text-xs font-semibold text-[#8e939e] hover:text-white transition-colors">
              Privacy
            </Link>
