      ...
      <footer className="border-t border-white/[0.07] py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://github.com/AiContextBrain/AI-Context-Brain" target="_blank" rel="noreferrer" onClick={() => trackEvent("github_click", { location: "footer" })} className="text-xs text-[#7ba3ff] hover:text-white">GitHub Repository</a>
