...
export default function ProjectSetupWizard({ isOpen, onClose, onSuccess }: ProjectSetupWizardProps) {
  ...
  useEffect(() => {
    ...
    if (pName) {
      setName(decodeURIComponent(pName));
    }
  }, []);
  ...
  const toggleStrictness = (id: string) => {
    setSelectedStrictnessLevels([id]);
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-md p-4 overflow-y-auto">
      <div className="w-full max-w-4xl bg-[#0d0f1a] border border-[#1d2035] rounded-3xl overflow-hidden shadow-2xl flex flex-col my-8" style={{ maxHeight: "85vh" }}>
        ...
        <div className="flex-1 p-6 overflow-y-auto" style={{ minHeight: "350px" }}>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <label className="block text-[11px] font-bold uppercase tracking-wider text-[#8b91b3]">Strictness Levels & Architecture Rules (Single-select)</label>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-dashed border-[#1d2035] bg-[#0d0f1a]/20 p-5 text-center">
                ...
                <p className="text-xs text-[#8b91b3] mt-1.5 leading-relaxed">
                  The runnable starter structure and project rules have been built server-side. Review them before creating the workspace in VS Code.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-[#4f7cff]/20 bg-[#4f7cff]/[0.02] p-4 flex gap-3 text-xs leading-relaxed">
                ...
                <div>
                  <strong className="text-white">Purely Deterministic Flow:</strong> Runnable starter files and AI rules are generated without consuming AI request limits.
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.05] p-5">
                ...
                <p className="mt-1 text-xs leading-5 text-[#8b91b3]">
                  Open the destination folder, then connect it in one click. The extension uses that folder name and creates runnable starter files before scanning and exporting AI context.
                </p>
              ...
              <div className="text-center py-4">
                ...
                <h4 className="font-black text-lg text-white mt-4">Starter Project & AI Memory Prepared!</h4>
                <p className="text-xs text-[#8b91b3] leading-relaxed mt-1">
                  Your project blueprint is registered. The extension creates real source, configuration, route, service, and test files after connecting the workspace.
                </p>
              </div>
